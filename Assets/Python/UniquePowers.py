...
#------------------AMERICAN U.P.-------------------
	...
	def doImmigration(self):
		...
		for iMigration in range(iNumMigrations):
			...
			message(iTargetPlayer, 'TXT_KEY_UP_IMMIGRATION', targetCity.getName(), event=InterfaceMessageTypes.MESSAGE_TYPE_MINOR_EVENT, button=infos.unit(iSettler).getButton(), color=iYellow, location=(x, y))
